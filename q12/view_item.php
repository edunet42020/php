                ...
                <div id="example_wrapper" class="dataTables_wrapper" role="grid">
                    <div class="datatable-header"><div id="example_filter" class="dataTables_filter">
                       ...
                       <table class="tableStatic" cellpadding="0" cellspacing="0" width="100%">
                           ...
                           <tbody>
                           <tr>
                               <td><?php echo $result['itembasicid'];?></td>
                               <td><?php echo $result['itemname'];?></td>
                               <td STYLE="text-align : center">
                                   <a href="edititem.php?pid=<?php echo $result['itembasicid'];?>" class="btn14"><img src = "images/edit1.png" title = "Edit"></a>
                                   <a href="delete_item.php?did=<?php echo $result['itembasicid'];?>" class="btn14"><img src = "images/delete.png" title = "follow_up"></a>
