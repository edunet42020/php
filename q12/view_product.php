                    ...
                    ?>
						<tr>
                           ...
                           <td> <?php echo $result['productprice'];?></td>
                            ...
                            <a href="edit_product.php?pid=<?php echo $result['productid'];?>" class="btn14"><img src = "images/edit1.png" title = "Edit"></a>
								<a href="delete_product.php?did=<?php echo $result['productid'];?>" class="btn14"><img src = "images/delete.png" title = "follow_up"></a>
							</td>
						</tr>
