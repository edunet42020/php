                ...
                <div id="example_wrapper" class="dataTables_wrapper" role="grid">
                    ...
                    <table class="tableStatic" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td width="10%">quantity gram</td>
                            <td width="5%">cost</td>
                            <td width="10%">price</td>
                            <td width="10%">date</td>
                            <td width="10%">remaining qtantity in kg</td>
                            <td width="10%">remaining qtantity in gram</td>
                        ...
                        <tr>
                            ...
                            <td><?php echo $result['itemdetailid'];?></td>
                            <?php
                            $i=$result["itembasicid"];
                                $s1="select itemname from itembasic where itembasicid=$i";
                                //echo $s1;
                            ...
                            <td><?php echo $result['qtykg'];?></td>
                            <td><?php echo $result['qtygram'];?></td>
                            <td><?php echo $result['cost'];?></td>
                            <td><?php echo $result['price'];?></td>
                            <td><?php echo $result['date'];?></td>
                            <td><?php echo $result['rqtykg'];?></td>
                            <td><?php echo $result['rqtygram'];?></td>

                            <td STYLE = "text-align : center">
                                <a href="edit_product.php?pid=<?php echo $result['pid'];?>" class="btn14"><img src = "images/edit1.png" title = "Edit"></a>
                                <a href="delete_product.php?did=<?php echo $result['pid'];?>" class="btn14"><img src = "images/delete.png" title = "follow_up"></a>
                            </td>
                        </tr>
                        </tbody>
                        <?php  } ?>
